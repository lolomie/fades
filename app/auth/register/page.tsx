      ...
      <div className="w-full max-w-md bg-white rounded-2xl border border-gray-200 p-8">
        {step === 1 ? (
          <>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div
                        className={`text-sm ${selectedPlan === plan.id ? 'text-gray-400' : 'text-gray-500'}`}
                      >
                        {plan.desc}
                      </div>
                    </div>
            ...
            <button
              onClick={() => setStep(2)}
              className="w-full bg-black text-white font-semibold py-3 rounded-xl hover:bg-gray-800 transition-all text-sm"
            >
              Weiter →
            </button>
          ...
          <>
            <button
              onClick={() => setStep(1)}
              className="text-gray-500 hover:text-black text-sm mb-4 flex items-center gap-1"
            >
              ← Zurück
            </button>
